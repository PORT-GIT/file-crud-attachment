...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('filemanagement', '0013_remove_filemovement_file_delete_filelog_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='filemanagement.filelog')),
            ],
        ),
    ]
